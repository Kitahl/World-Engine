...
def find_ngrok() -> str | None:
    ...
    if cleanup["failed"] or cleanup["refused"]:
        print(
            "[4.5.0-SAFE] Obsolete portable ngrok cache could not be fully removed; "
...
def download_portable_ngrok_windows() -> str:
    ...
    print("[4.5.0-SAFE] Installing the pinned ngrok package from Microsoft Store via WinGet...")
    try:
