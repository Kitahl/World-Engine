...
4. Paste `CUSTOM_GPT_INSTRUCTIONS_V394.txt` into GPT Instructions. It stays below the 8,000-character limit.
...
8. Do **not** upload `legacy/World_Engine_1.63.txt` as active GPT Knowledge. It is retained only as a historical requirements reference; v3.9.4 backend state, OpenAPI and `CUSTOM_GPT_INSTRUCTIONS_V394.txt` are authoritative.
