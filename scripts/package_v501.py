...
RELEASE = "5.0.1"
PACKAGE_ROOT = "world_engine_v5_0_1_QUALIFICATION_HARDENED_WINDOWS_FULL"
PACKAGE_NAME = PACKAGE_ROOT + ".zip"
HANDOFF_NAME = "WORLD_ENGINE_V501_HANDOFF.json"
CRITICAL_FILES = (
    ...
    "CUSTOM_GPT_INSTRUCTIONS_V501.txt",
    "GPT_INSTRUCTIONS.md",
    "README.md",
    ...
    "scripts/release_verify_v501.py",
    "scripts/package_v501.py",
    ...
    with tempfile.TemporaryDirectory(prefix="world-engine-v501-audits-") as temporary:
        ...
        narrative_result = inherited.run(
            [
                ...
                "scripts/narrative_release_audit.py",
                "--output",
                str(audit_dir / "WORLD_ENGINE_V501_NARRATIVE_AUDIT.json"),
            ],
            cwd=tree,
            check=False,
            timeout=300,
