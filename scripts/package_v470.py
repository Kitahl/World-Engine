#!/usr/bin/env python3
"""Build and independently verify the full World Engine 4.7.0 Windows archive."""
...
PACKAGE_ROOT = "world_engine_v4_7_0_CANONICAL_ECONOMY_POPULATION_WINDOWS_FULL"
PACKAGE_NAME = PACKAGE_ROOT + ".zip"
HANDOFF_NAME = "WORLD_ENGINE_V470_HANDOFF.json"
CRITICAL_FILES = (
    ...
    "scripts/release_verify_v470.py",
    "scripts/package_v470.py",
    "openapi_actions.json",
    "CUSTOM_GPT_INSTRUCTIONS_V470.txt",
    "GPT_INSTRUCTIONS.md",
    "BUILD_REPORT_V470.md",
    "V4_7_CHANGELOG.md",
    "THREE_DONOR_INTEGRATION_REPORT_V470.md",
    "AUTHORING_GUIDE.md",
    "AUTHORING_PAYLOAD_SCHEMA.json",
    "mcp_server.py",
    "world_engine/environment.py",
    "world_engine/mechanisms.py",
    "world_engine/economy.py",
    "world_engine/population.py",
    ...
    "tests/test_v470_mechanisms.py",
    "tests/test_v470_economy.py",
    "tests/test_v470_population.py",
    "tests/test_v470_mcp_boundary.py",
...
def verify_tree(tree: Path) -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix="world-engine-v470-audits-") as audit_temp:
        ...
        narrative_result = run(
            [
                ...
                "--output",
                str(audit_dir / "WORLD_ENGINE_V470_NARRATIVE_AUDIT.json"),
            ],
            cwd=tree,
            check=False,
            timeout=300,
...
def verify_extracted(zip_path: Path) -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix="world-engine-v470-extracted-") as temp:
...
def main() -> int:
    ...
    handoff = {
        "handoff_version": "WE470-HANDOFF-1.0",
        "release": "4.7.0",
