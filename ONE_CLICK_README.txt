...
5. In GPT Builder, use CUSTOM_GPT_INSTRUCTIONS_V500.txt and the generated openapi_actions_PERMANENT.json.
...
If startup reports DEGRADED, the local engine and desktop may still be ready while the external tunnel needs account configuration or recovery. See PERMANENT_ENDPOINT_GUIDE.md and BUILD_REPORT_V500.md.
