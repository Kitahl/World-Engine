...
from scripts import release_verify_v500 as release_verify
...
class AutomaticStartupTests(unittest.TestCase):
    ...
    def test_current_compact_gpt_instructions_fit_limit_and_require_router_publication_and_fail_closed_connection(self):
        root = Path(startup.__file__).resolve().parent
        instructions = (root / "CUSTOM_GPT_INSTRUCTIONS_V500.txt").read_text(encoding="utf-8")
    ...
    def test_release_verifier_audits_active_v500_instructions(self):
        ...
        self.assertEqual("CUSTOM_GPT_INSTRUCTIONS_V500.txt", result["active_instruction_file"])
    ...
    def test_windows_entrypoints_reference_current_installers_and_private_runtime(self):
        ...
        self.assertIn("World Engine 5.0.0", default_endpoint)
        self.assertIn("World Engine 5.0.0 permanent endpoint installer", legacy_installer)
